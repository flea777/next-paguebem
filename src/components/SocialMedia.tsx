      ...
      <ul className="flex flex-col items-center space-y-3">
        <li>
          <Link href="https://instagram.com" target="_blank" aria-label="Instagram">
            <span className="bg-[#2D4416] rounded-full p-1 sm:p-2 lg:p-3 flex items-center justify-center text-white hover:bg-green-600 transform hover:scale-100 transition-all duration-300 ease-in-out">
