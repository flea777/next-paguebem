...
import PagueBemProtegeIcon from './PagueBemRecuperaIcon';

interface PagueBemProtegeProps {
  title: string;
  description: string;
}

const PagueBemProtege: React.FC<PagueBemProtegeProps> = ({ title, description }) => {
  return (
...
export default PagueBemProtege;