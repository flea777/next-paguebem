...
import PagueBemConversasIcon from './PagueBemConversasIcon';

interface PagueBemConversasProps {
  title: string;
  description: string;
}

const PagueBemConversas: React.FC<PagueBemConversasProps> = ({ title, description }) => {
  return (
...
export default PagueBemConversas;